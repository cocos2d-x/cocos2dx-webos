...
//	CCLog(" --- Into fullPathFromRelativePath %s %s %s...\n",pszFilename,pszRelativeFile,pRet->m_sString.c_str());
	return pRet->m_sString.c_str();
}

unsigned char* CCFileUtils::getFileData(const char* pszFileName, const char* pszMode, unsigned long * pSize) {

    CCLog("--- Into CCFileUtils::getFileData(%s,%s,%d) \n ",pszFileName,pszMode,pSize);
